...
Emitter.prototype.on = function(event, fn, obj){
  ...
  (this._callbacks[event] = this._callbacks[event] || [])
    .push({func: fn, obj: obj});
    // console.log("注册了事件监听", event, this._callbacks[event].length);
    return this;
};
